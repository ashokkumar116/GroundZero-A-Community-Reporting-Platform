...
const EditAnnouncementModal = ({visible,setVisible,selectedImages,setSelectedImages,title,setTitle,description,setDescription,handleSubmit,loading,editId}) => {
  ...
  return (
    <Dialog
        ...
        visible={visible}
        onHide={() => {setVisible(false);setSelectedImages([]);setTitle("");setDescription("");}}
    >
      <form className='flex flex-col gap-2' onSubmit={(e)=>handleSubmit(e,editId)}>
            ...
            >
                {
                    loading ? (
                        <>
                            ...
                            <p>Saving announcement...</p>
                        </>
                    ) : (
                        <>
                            <AiOutlineSave/>
                            <p>Save Announcement</p>
                        </>
                    )
                }
            </button>
