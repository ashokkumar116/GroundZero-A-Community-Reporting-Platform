        ...
        <div className="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] ">  
                <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                    ...
                    <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent font-medium">Powered by People</span>
                </div>
                <h2 className="text-2xl md:text-4xl font-medium mt-2">
                    The spark of every revolution starts right here — with <br />
                    <span className="bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent">you and GroundZero.</span>
                </h2>
                ...
                <a href="/register" type="button" className="bg-gradient-to-r from-purple-600 to-blue-500 text-white text-sm px-5 py-2.5 rounded-xl font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300"> 
                    Start Making Change
                </a>
