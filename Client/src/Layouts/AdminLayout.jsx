  ...
  return (
    <div className='gap-10 bg-gray-50'>
        ...
        <div className='flex'>
            {
                open && (
                    <div className='inset-0 fixed z-60 bg-black/50 '>
                        <div className='w-60 h-screen bg-white fixed top-0 z-60 shadow-lg border-r border-gray-500/30 transition-all duration-300 ease-in-out'>
                            <SideBar/>
                        </div>
            ...
            <aside className='w-60 h-screen bg-white fixed top-0 z-60 shadow-lg border-r border-gray-500/30 hidden lg:block'>
                <SideBar/>
            </aside>
            <main className='flex-1'>
                <div className='flex flex-col gap-10'>
                    <div className='bg-white lg:w-[calc(100%-240px)] w-full fixed lg:left-60 left-0 top-0 z-50 shadow-lg flex items-center gap-2 p-2 justify-between lg:justify-end'>
                        <div className="lg:hidden">
                            <button className="flex items-center gap-2 p-2 rounded-md cursor-pointer hover:bg-gray-200/50 transition-all duration-300 ease-in-out" onClick={()=>setOpen(true)}>
                    ...
                    <div className='lg:pl-70 pl-10 pr-10 pb-10 pt-30 h-screen overflow-y-auto border-b border-gray-500/30'>
                        <Outlet />
                    </div>
                </div>
            </main>
